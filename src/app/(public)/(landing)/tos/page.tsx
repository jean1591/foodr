    ...
    <div>
      ...
      <div className="mt-12 space-y-8">
        ...
        <div>
          ...
          <p>
            The content generated by this app is for informational purposes only
            and may not always be accurate or complete. Users are advised to
            verify the information, particularly recipes, independently. The app
            and its creators are not responsible for any errors, omissions, or
            outcomes resulting from the use of this content. By using this site,
            users acknowledge and agree to these terms and the need to
